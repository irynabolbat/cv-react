        ...
        <div className={style.contacts}>
            ...
            <ul className={style.contacts_wrapper}>
                <li className={style.contact_link_container}>
                    <a href='mailto:irinabolbat@gmail.com' target="_blank" className={style.contact_link}>
                        <Envelope/>
                        irinabolbat98@gmail.com
                    </a>
                </li>
                <li className={style.contact_link_container}>
                    <a href='https://www.linkedin.com/in/iryna-bolbat-011204209/' target="_blank" className={style.contact_link}>
                        <Linkedin/>
                        <span>Iryna Bolbat</span>
                    </a>
                </li>
                <li className={style.contact_link_container}>
                    <a href='https://github.com/irinabolbat' target="_blank" className={style.contact_link}>
                        <Github/>
                        irinabolbat
                    </a>
                </li>
                <li className={style.contact_link_container}>
                    <a href='https://t.me/irina_bolbat' target="_blank" className={style.contact_link}>
                        <Telephone/>
                        +38 (095) 606 67 19
                    </a>
                </li>
